...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Check If SNILS + OGRN Are Unique
    	Validator::extend('are_snils_ogrn_unique', function($attribute, $value, $parameters, $validator)
		{
			$inputs = $validator->getData();
