...
return [
    ...
    */
	...
	'are_snils_ogrn_unique' => 'Пара значений полей :attribute уже существуют.',
    ...
    */
    ...
    'attributes' => [
    	...
    	'id' => '"Код"',
    	'snils' => '"СНИЛС"',
    	'snils_ogrn' => '"СНИЛС" и "ОГРН/ОГРНИП"',
    	...
    	'template_field201' => '"Текст чек-бокса акцепта документа"',
    	'template_field205' => '"Список префиксов Оферты для проверки"',
    	'doc_field1' => '"Текст договора"',
    	'doc_field74' => '"Полное наименование организации"',
    	...
    	'doc_field41' => '"Краткое наименование организации"',
